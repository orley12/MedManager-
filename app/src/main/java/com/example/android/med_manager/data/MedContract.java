...
public class MedContract {
    ...
    public static final class ProfileEntry implements BaseColumns {
        ...
        public static final String PROFILE_COLUMN_USER_PHOTO_URI = "photo_url";
        public static final String PROFILE_COLUMN_EMAIL = "email";
        public static final String PROFILE_COLUMN_FIRST_NAME = "name";
        public static final String PROFILE_COLUMN_LAST_NAME = "surname";
    ...
    public static final class MedEntry implements BaseColumns {
        ...
        public static final String MED_COLUMN_HOURS_OR_MINUTES = "med_hours_or_minutes";
